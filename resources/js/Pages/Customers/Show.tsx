    ...
    return <AppLayout title={customer.name}>
        ...
        <div className="content-grid">
            ...
            <div style={{ display: 'grid', gap: 18 }}>
                <section className="panel">
                    <h2>{t('profile')}</h2>
                    <form onSubmit={event => { event.preventDefault(); profile.put(`/customers/${customer.id}`); }} style={{ display: 'grid', gap: 12 }}>
                ...
                <section className="panel">
                    ...
                    <form onSubmit={event => { event.preventDefault(); note.post(`/customers/${customer.id}/notes`, { onSuccess: () => note.reset() }); }}>
