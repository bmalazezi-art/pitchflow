...
export default function Reservations({ reservations, filters }: { reservations: Paginated<any>; filters: { search?: string } }) {
    ...
    return <AppLayout title={t('reservations')}><Head title={t('reservations')} /><div className="page-header"><div><h1>{t('reservations')}</h1><p>{t('reservationsIntro')}</p></div></div>
